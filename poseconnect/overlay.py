...
KEYPOINT_CONNECTORS_BY_POSE_MODEL = {
    ...
    'BLAZEPOSE': [[8, 6], [6, 5], [5, 4], [4, 0], [0, 1], [1, 2], [2, 3], [3, 7], [10, 9], [16, 18], [18, 20], [20, 16], [16, 22], [16, 14], [14, 12], [15, 17], [17, 19], [19, 15], [15, 21], [15, 13], [13, 11], [12, 11], [12, 24], [11, 23], [24, 23], [24, 26], [26, 28], [28, 32], [32, 30], [30, 28], [23, 25], [25, 27], [27, 31], [31, 29], [29, 27]],
    'HALPE-26': [[17, 18], [18, 19], [17, 0], [17, 1], [17, 2], [17, 3], [17, 4], [18, 5], [5, 7], [7, 9], [18, 6], [6, 8], [8, 10], [19, 11], [11, 13], [13, 15], [15, 24], [24, 20], [24, 22], [19, 12], [12, 14], [14, 16], [16, 25], [25, 21], [25, 23]]
}
...
def overlay_poses_2d(
    ...
    pose_color_column=poseconnect.defaults.OVERLAY_POSE_COLOR_COLUMN,
    ...
    overlay_poses_video(
        ...
        pose_color_column=pose_color_column,
...
def overlay_poses_image(
    ...
    for pose_id, row in poses.iterrows():
        if pose_color_column is not None:
            pose_color_pose = row[pose_color_column]
        else:
            pose_color_pose = pose_color
