...
OVERLAY_POSE_LABEL_COLOR = 'white'
OVERLAY_POSE_LABEL_BACKGROUND_ALPHA = 0.6
OVERLAY_POSE_LABEL_FONT_SCALE = 1.5
OVERLAY_POSE_LABEL_LINE_WIDTH = 1
...
OVERLAY_TIMESTAMP_TEXT_ALPHA = 1.0
OVERLAY_TIMESTAMP_BOX_LINE_WIDTH = 0
OVERLAY_TIMESTAMP_BOX_COLOR = 'black'
OVERLAY_TIMESTAMP_BOX_FILL = True
